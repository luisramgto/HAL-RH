...
BEGIN TRANSACTION
GO
INSERT INTO [PAGOS] ([id_pagos], [descripcion_pagos]) VALUES (N'01', N'Pago 1'), (N'02', N'Pago 2'), (N'03', N'Pago 3')
GO
GO
COMMIT TRANSACTION
GO
...
-- ----------------------------
-- Procedure structure for mostrar_empleados_ex
-- ----------------------------
DROP PROCEDURE [mostrar_empleados_ex]
GO

CREATE proc [mostrar_empleados_ex]
as
SELECT
dbo.EMPLEADOS.fecha_exportacion AS [FECHA EXPORTADO],
