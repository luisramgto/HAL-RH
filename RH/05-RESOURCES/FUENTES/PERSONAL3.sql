...
[reingreso] varchar(10) NULL ,
[bajaimss] varchar(10) NULL ,
...
[iniciacon] varchar(10) NULL ,
[finalcon] varchar(10) NULL ,
...
BEGIN TRANSACTION
GO
INSERT INTO [EMPLEADOS] ([numero], [credencial], [nombre], [apellido1], [apellido2], [estado], [edocivil], [sexo], [tiponom], [turno], [ccto], [depto], [puesto], [codigopago], [codahorro], [politica], [rfc], [imss], [curp], [fechanac], [lugarorig], [entidad], [nacional], [hijos], [fechaalta], [fechabaja], [reingreso], [bajaimss], [motbaja], [sueldo], [sueldoimss], [sueldoinfo], [iniciasuel], [sdi_var], [motivo], [tipo_suel], [tipocontra], [iniciacon], [finalcon], [zona], [estadodir], [ciudad], [colonia], [direccion], [telefono], [codpostal], [escolarid], [carrera], [aplica_sub], [tipo_empl], [tjornada], [clavebanco], [tregimen], [regpatron], [utilidades], [claseries], [metodop], [status_exportacion], [fecha_exportacion], [user_lastupdate], [motivo_rechazo]) VALUES (N'03698', N'03698', N'Margarita Montserrat', N'Araujo', N'Ramirez', N'A', N'C', N'F', N'01', N'01', N'1201', N'1201', N'019', N'01', N'01', N'01', N'AARM910220GM9', N'12119111982', N'AARM910220MGTRMR01', N'1991-02-20', N'GUANAJUATO', N'11', N'MEXICANA', N'2', N'2016-09-21', N'2016-09-21', N'2016-09-21', N'2016-09-21', N'0', N'147', N'153.65', N'153.65', N'2016-09-21', N'0', N'1', N'1', N'O', N'2016-09-21', N'2016-09-21', N'A', N'11', N'0296', N'60000', N'Andador Corrientes', N'4774737738', N'37479', N'9', N'0', N'f', N'1', N'NORMAL', N'072', N'1', N'HALMEX', N'T', N'1', N'3', N'0', null, null, null), (N'03699', N'03699', N'Jose De Jesus Omar', N'Venegas', N'Ramirez', N'A', N'S', N'M', N'02', N'02', N'1201', N'1201', N'020', N'01', N'01', N'01', N'VERJ9210181H5', N'63109212215', N'VERJ921018HGTNMS09', N'27/09/2016', N'GUANAJUATO', N'11', N'MEXICANA', N'1', N'26/09/2016', N'00/00/0000', N'00/00/0000', N'00/00/0000', N'0', N'147', N'153.65', N'153.65', N'2016-09-27', N'0', N'1', N'2', N'T', N'27/09/2016', N'00/00/0000', N'A', N'22', N'0406', N'60002', N'Blanco', N'4727387365', N'36100', N'5', N'xxxx', N'T', N'1', N'Normal', N'073', N'2', N'00/00/0000', N'T', N'1', N'1', N'0', N'00/00/0000', N'admin', null)
GO
GO
COMMIT TRANSACTION
GO
...
-- ----------------------------
-- Table structure for EMPLEADOS_copy
-- ----------------------------
DROP TABLE [EMPLEADOS_copy]
GO
...
IF ((SELECT COUNT(*) from fn_listextendedproperty('MS_Description', 
'SCHEMA', N'dbo', 
'TABLE', N'EMPLEADOS_copy', 
'COLUMN', N'numero')) > 0) 
EXEC sp_updateextendedproperty @name = N'MS_Description', @value = N'NUMERO DE EMPLEADO'
, @level0type = 'SCHEMA', @level0name = N'dbo'
, @level1type = 'TABLE', @level1name = N'EMPLEADOS_copy'
, @level2type = 'COLUMN', @level2name = N'numero'
ELSE
EXEC sp_addextendedproperty @name = N'MS_Description', @value = N'NUMERO DE EMPLEADO'
, @level0type = 'SCHEMA', @level0name = N'dbo'
...
-- ----------------------------
-- Records of EMPLEADOS_copy
-- ----------------------------
BEGIN TRANSACTION
GO
INSERT INTO [EMPLEADOS_copy] ([numero], [credencial], [nombre], [apellido1], [apellido2], [estado], [edocivil], [sexo], [tiponom], [turno], [ccto], [depto], [puesto], [codigopago], [codahorro], [politica], [rfc], [imss], [curp], [fechanac], [lugarorig], [entidad], [nacional], [hijos], [fechaalta], [fechabaja], [reingreso], [bajaimss], [motbaja], [sueldo], [sueldoimss], [sueldoinfo], [iniciasuel], [sdi_var], [motivo], [tipo_suel], [tipocontra], [iniciacon], [finalcon], [zona], [estadodir], [ciudad], [colonia], [direccion], [telefono], [codpostal], [escolarid], [carrera], [aplica_sub], [tipo_empl], [tjornada], [clavebanco], [tregimen], [regpatron], [utilidades], [claseries], [metodop], [status_exportacion], [fecha_exportacion], [user_lastupdate], [motivo_rechazo]) VALUES (N'03698', N'03698', N'Margarita Montserrat', N'Araujo', N'Ramirez', N'A', N'C', N'F', N'01', N'01', N'1201', N'1201', N'019', N'01', N'01', N'01', N'AARM910220GM9', N'12119111982', N'AARM910220MGTRMR01', N'1991-02-20', N'GUANAJUATO', N'11', N'MEXICANA', N'2', N'2016-09-21', N'2016-09-21', N'2016-09-21', N'2016-09-21', N'0', N'147', N'153.65', N'153.65', N'2016-09-21', N'0', N'1', N'1', N'O', N'2016-09-21', N'2016-09-21', N'A', N'11', N'0296', N'60000', N'Andador Corrientes', N'4774737738', N'37479', N'9', N'0', N'f', N'1', N'NORMAL', N'072', N'1', N'HALMEX', N'T', N'1', N'3', N'0', null, null, null)
GO
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
INSERT INTO [METODOSPAGOS] ([id_metodospago], [metodo_pago]) VALUES (N'1', N'Efectivo'), (N'2', N'Cheque'), (N'3', N'Transferencia')
GO
GO
COMMIT TRANSACTION
GO
...
BEGIN TRANSACTION
GO
INSERT INTO [TURNOS] ([id_turno], [tipo_turno]) VALUES (N'01', N'Turno 1'), (N'02', N'Turno 2'), (N'03', N'Turno 3')
GO
GO
COMMIT TRANSACTION
GO
...
-- ----------------------------
-- Procedure structure for insertar_empleados_copy
-- ----------------------------
DROP PROCEDURE [insertar_empleados_copy]
GO

create proc [insertar_empleados_copy]
@numero varchar(10),
@credencial varchar(10),
@nombre varchar(20),
@apellido1 varchar(20),
...
INSERT INTO EMPLEADOS (numero, credencial, nombre, apellido1, apellido2, estado, edocivil, sexo, tiponom, turno, ccto, depto, puesto, codigopago, codahorro, politica, rfc, imss, curp, fechanac, lugarorig, entidad, nacional, hijos, fechaalta, fechabaja, reingreso, bajaimss, motbaja, sueldo, sueldoimss, sueldoinfo, iniciasuel, sdi_var, motivo, tipo_suel, tipocontra, iniciacon, finalcon, zona, estadodir, ciudad, colonia, direccion, telefono, codpostal, escolarid, carrera, aplica_sub, tipo_empl, tjornada, clavebanco, tregimen, regpatron, utilidades, claseries, metodop, status_exportacion, fecha_exportacion, user_lastupdate, motivo_rechazo)
VALUES (@numero, @credencial,@nombre,@apellido1,@apellido2,@estado,@edocivil,@sexo,@tiponom,@turno,@ccto,@depto,@puesto,@codigopago,@codahorro,@politica,@rfc, @imss, @curp, @fechanac, @lugarorig,@entidad, @nacional,@hijos, @fechaalta, @fechabaja,@reingreso,@bajaimss, @motbaja, @sueldo, @sueldoimss, @sueldoinfo, @iniciasuel,@sdi_var,@motivo, @tipo_suel,@tipocontra,@iniciacon, @finalcon,@zona, @estadodir, @ciudad, @colonia, @direccion, @telefono, @codpostal, @escolarid, @carrera, @aplica_sub, @tipo_empl, @tjornada, @clavebanco, @tregimen, @regpatron, @utilidades, @claseries, @metodop, @status_exportacion, @fecha_exportacion, @user_lastupdate, @motivo_rechazo)
...
dbo.EMPLEADOS.[numero] AS [NO],
dbo.EMPLEADOS.nombre AS NOMBRE,
dbo.EMPLEADOS.apellido1 AS [AP PATERNO],
dbo.EMPLEADOS.apellido2 AS [AP MATERNO],
dbo.EMPLEADOS.turno AS TURNO,
dbo.EMPLEADOS.depto AS DEPARTAMENTO,
dbo.EMPLEADOS.puesto AS PUESTO,
dbo.EMPLEADOS.rfc AS RFC,
dbo.EMPLEADOS.imss AS IMMSS,
dbo.EMPLEADOS.curp AS CURP,
dbo.EMPLEADOS.fechanac AS [FECHA NACIMIENTO],
DATEDIFF(yy,dbo.EMPLEADOS.fechanac,GETDATE()) AS EDAD,
dbo.EMPLEADOS.lugarorig AS [LUGAR ORIGEN],
dbo.EMPLEADOS.ciudad AS CIUDAD,
dbo.EMPLEADOS.colonia AS COLONIA,
dbo.EMPLEADOS.direccion AS [DIRECCIÓN],
dbo.EMPLEADOS.telefono AS TEL,
dbo.EMPLEADOS.escolarid AS ESCOLARIDAD,
dbo.EMPLEADOS.carrera AS CARRERA

FROM
dbo.EMPLEADOS
WHERE
dbo.EMPLEADOS.status_exportacion = '0'
...
-- ----------------------------
ALTER TABLE [EMPLEADOS] ADD PRIMARY KEY ([status_exportacion], [numero])
GO

-- ----------------------------
-- Indexes structure for table EMPLEADOS_copy
-- ----------------------------

-- ----------------------------
-- Primary Key structure for table EMPLEADOS_copy
-- ----------------------------
ALTER TABLE [EMPLEADOS_copy] ADD PRIMARY KEY ([status_exportacion], [numero])
GO
...
-- ----------------------------
-- Foreign Key structure for table [EMPLEADOS_copy]
-- ----------------------------
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([ccto]) REFERENCES [CENTROCOSTOS] ([id_ccto]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([ciudad]) REFERENCES [CIUDADES] ([id_ciudad]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([clavebanco]) REFERENCES [BANCOS] ([id_bancos]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([codahorro]) REFERENCES [FONDOSAHORRO] ([id_fondo_ahorro]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([codigopago]) REFERENCES [PAGOS] ([id_pagos]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([colonia]) REFERENCES [COLONIAS] ([id_colonia]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([depto]) REFERENCES [DEPARTAMENTOS] ([id_departamento]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([depto]) REFERENCES [DEPARTAMENTOS] ([id_departamento]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([estadodir]) REFERENCES [ESTADOS] ([id_estados]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([metodop]) REFERENCES [METODOSPAGOS] ([id_metodospago]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([motivo_rechazo]) REFERENCES [MOTIVODESCARTO] ([id_motivo]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([politica]) REFERENCES [POLITICASBENEFICIOS] ([id_politica]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([puesto]) REFERENCES [PUESTOS] ([id_puesto]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([tiponom]) REFERENCES [NOMINAS] ([id_nomina]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([turno]) REFERENCES [TURNOS] ([id_turno]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
ALTER TABLE [EMPLEADOS_copy] ADD FOREIGN KEY ([user_lastupdate]) REFERENCES [USUARIOS] ([username]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
