...
Public Class frmcandidatos_rechazados
    Dim func As New fCandidatos
    Dim dt As New DataTable
    Dim dt_exportar As New DataTable
    Public Shared _instancia As frmcandidatos_rechazados
    ...
    Public Function getinstancia() As frmcandidatos_rechazados
        If (_instancia Is Nothing) Then
            _instancia = New frmcandidatos_rechazados()
        End If
        Return _instancia
    End Function
    ...
    Public Sub FillGrid()
        dt.Clear()
        dt = func.mostrar_candidatos_rechazados
    ...
    Private Sub Btnnuevo_Click(sender As Object, e As EventArgs) Handles Btnnuevo.Click
        Dim frmNuevo As frmmantecandidato_rechazados = New frmmantecandidato_rechazados()

        frmNuevo.btn_editar.Visible = False
        frmNuevo.lbl_MOTIVO.Visible = True
        frmNuevo.cmb_MOTIVO.Visible = True
        frmNuevo.lbl_MOTIVO_OTRO.Visible = True
        frmNuevo.txt_OTROMOTIVO.Visible = True
    ...
    Private Sub btn_cancelar_Click(sender As Object, e As EventArgs) Handles btn_cancelar.Click
        Me.Close()
        'frminicio.btn_OK.Visible = True
        'frminicio.btn_RECHAZADOS.Visible = True
    End Sub
    ...
    Private Sub btnexportar_Click_1(sender As Object, e As EventArgs) Handles btnexportar.Click
        ...
        'ProgressBar1.Visible = True
        progressbar()
        dt_exportar = func.mostrar_candidatos_rechazados_ex
    ...
    Private Sub editar()
        ...
        Dim frmEditar As frmmantecandidato_rechazados = New frmmantecandidato_rechazados()

        frmEditar.btn_insertar.Visible = False
        frmEditar.btn_editar.Visible = True
        frmEditar.lbl_MOTIVO.Visible = True
        frmEditar.cmb_MOTIVO.Visible = True
        ...
        If Convert.IsDBNull(dgv_NUEVOSITEMS.SelectedRows(0).Cells(69).Value) Then
            frmEditar.cmb_MOTIVO.Text = "Seleccione..."
        Else
            frmEditar.cmb_MOTIVO.Text = dgv_NUEVOSITEMS.SelectedRows(0).Cells(69).Value
        End If
