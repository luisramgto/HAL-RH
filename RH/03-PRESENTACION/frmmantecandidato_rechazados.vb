...
Public Class frmmantecandidato_rechazados
    ...
    Public Sub cargar()
        ...
        Else
            ...
            If cmb_MOTIVO.Text = "Seleccione..." Then
                VS = cmb_MOTIVO.Text
                dt = func.mostrar_tabla("motivo_descarto")
                If dt.Rows.Count <> 0 Then
                    cmb_MOTIVO.DataSource = dt
    ...
    Public Sub insertar_update()
        If ValidarCampos() = True Then
            Try
                ...
                'dts.d_motivo_rechazo = cmb_MOTIVO.SelectedValue.ToString
    ...
    Public Function ValidarCampos() As Boolean
        ...
        If cmb_MOTIVO.Text = "Seleccione..." Then
            MessageBox.Show("El campo -MOTIVO DE DESCARTO- se encuentra vacio." & vbCrLf & "Por favor ingrese un dato valido", _
                             "Campo vacio", _
                             MessageBoxButtons.OK, _
                             MessageBoxIcon.Exclamation)
            cmb_MOTIVO.Select()
