...
Public Class frmcandidatos_aceptados
    ...
    Public Shared _instancia As frmcandidatos_aceptados
    ...
    Public Function getinstancia() As frmcandidatos_aceptados
        If (_instancia Is Nothing) Then
            _instancia = New frmcandidatos_aceptados()
        End If
        Return _instancia
    End Function
    ...
    Public Sub FillGrid()
        dt.Clear()
        dt = func.mostrar_candidatos_aceptados
    ...
    Private Sub Btnnuevo_Click(sender As Object, e As EventArgs) Handles Btnnuevo.Click
        Dim frmNuevo As frmmantecandidato_aceptados = New frmmantecandidato_aceptados()
    ...
    Private Sub btnexportar_Click_1(sender As Object, e As EventArgs) Handles btnexportar.Click
        ...
        'Dim frmRangoFecha As frmrangoexport_aceptados = New frmrangoexport_aceptados()
